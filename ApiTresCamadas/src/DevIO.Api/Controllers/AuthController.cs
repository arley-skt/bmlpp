...
namespace DevIO.Api.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        {
            var lista = await _usuarioService.Todos(ativo);
        ...
        {
            var usuarioporid = await _usuarioService.ObterusuarioporId(Id);

            return CustomResponse(HttpStatusCode.OK, usuarioporid);
        }
